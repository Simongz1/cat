...
class ComputeIsoPlasticPFFractureStressDegrEspec : public ComputeStressBase
{
public:
  static InputParameters validParams();
  ComputeIsoPlasticPFFractureStressDegrEspec(const InputParameters & parameters);
...
protected:
  ...
  MaterialProperty<Real> & _deltaT;

  MaterialProperty<Real> & _pdeg;
  MaterialProperty<Real> & _sigeqv;
  MaterialProperty<Real> & _F_posvol;
  MaterialProperty<Real> & _F_posdev;
  MaterialProperty<Real> & _F_neg;
  ...
  MaterialProperty<RankTwoTensor> & _stress_deg;
  MaterialProperty<RankTwoTensor> & _stress_p;
  MaterialProperty<RankTwoTensor> & _stress0neg;

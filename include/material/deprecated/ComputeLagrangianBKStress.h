...
class ComputeLagrangianBKStress
...
public:
  ...
  ComputeLagrangianBKStress(const InputParameters & parameters);
...
protected:
  ...
  const MaterialProperty<RankTwoTensor> &_cauchy_bk;
  const MaterialProperty<RankTwoTensor> &_bp;

...
class ComputeMieGruneisenPlasticPFFractureStressDebug : public ComputeStressBase
{
public:
  static InputParameters validParams();
  ComputeMieGruneisenPlasticPFFractureStressDebug(const InputParameters & parameters);

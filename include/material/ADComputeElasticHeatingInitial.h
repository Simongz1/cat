...
class ADComputeElasticHeatingInitial;

class ADComputeElasticHeatingInitial : public Material
{
public:
    ADComputeElasticHeatingInitial(const InputParameters & parameters);

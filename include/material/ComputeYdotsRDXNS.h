...
class ComputeYdotsRDXNS;

class ComputeYdotsRDXNS : public Material
{
public:
    ComputeYdotsRDXNS(const InputParameters & parameters);
...
private:
    ...
    const Real _rate_limit; // rate limit for the reaction

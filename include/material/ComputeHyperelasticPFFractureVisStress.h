...
// class ComputeHyperelasticPFFractureVisStress;

// InputParameters validParams<ComputeHyperelasticPFFractureVisStress>();

/**
 * Phase-field fracture
 * This class computes the stress update due to artificial viscosity damping
 */
class ComputeHyperelasticPFFractureVisStress : public ComputeLinearElasticPFFractureStress
{
public:
  static InputParameters validParams();
  ComputeHyperelasticPFFractureVisStress(const InputParameters & parameters);

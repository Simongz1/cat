...
class ADComputePlasticHeatingInitial;

class ADComputePlasticHeatingInitial : public Material
{
public:
    ADComputePlasticHeatingInitial(const InputParameters & parameters);

...
class DecompositionRDX : public HeatSource
{
public:
  DecompositionRDX(const InputParameters & parameters);
...
private:
  ...
  const MaterialProperty<Real> &_Q1;
  const MaterialProperty<Real> &_Q2;
};

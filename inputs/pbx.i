...
[Materials]
  ...
  [yield_mixture]
    ...
    constant_expressions = '0.3 0.1 0.1 3 0.1'
...
[AuxKernels]
  ...
  [readVoronoiStructure]
    ...
    bulk_RDX_density = 1850 #provided in g/cm³
  []
...
[GlobalParams]
  ...
  l_cracks = 1 #unused
  n_pores = 10000000
  pore_probability = 0.0075# default is 0.01


  bulk_RDX_fraction = 1. ##saturated RDX
  pore_RDX_fraction = 0.95 ##this should be deprecated
  range_pore = '101 103'

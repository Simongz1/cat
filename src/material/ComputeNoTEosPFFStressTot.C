...
#include "ComputeNoTEosPFFStressTot.h"

registerMooseObject("TensorMechanicsApp", ComputeNoTEosPFFStressTot);

InputParameters
ComputeNoTEosPFFStressTot::validParams()
{
...
ComputeNoTEosPFFStressTot::ComputeNoTEosPFFStressTot(const InputParameters & parameters)
...
void
ComputeNoTEosPFFStressTot::initQpStatefulProperties()
{
...
void
ComputeNoTEosPFFStressTot::computeQpStress()
{
...
//------------------------------------------------------------------------------
  ...
  Real trD, jacob, q_bv;
  // TODO might need to change to total strain here as well
...
Real
ComputeNoTEosPFFStressTot::yieldFunction(const RankTwoTensor & stress, const Real yield_stress)
{
  return getSigEqv(stress) - yield_stress;
}

RankTwoTensor
ComputeNoTEosPFFStressTot::dyieldFunction_dstress(const RankTwoTensor & sig)
{
...
Real
ComputeNoTEosPFFStressTot::dyieldFunction_dinternal(const Real equivalent_plastic_strain)
{
  return -getdYieldStressdPlasticStrain(equivalent_plastic_strain);
}

RankTwoTensor
ComputeNoTEosPFFStressTot::flowPotential(const RankTwoTensor & sig)
{
  return dyieldFunction_dstress(sig); // this plasticity model assumes associative flow
}

Real
ComputeNoTEosPFFStressTot::internalPotential()
{
  return -1;
}

Real
ComputeNoTEosPFFStressTot::getSigEqv(const RankTwoTensor & stress)
{
...
void
ComputeNoTEosPFFStressTot::getJac(const RankTwoTensor & sig,
...
Real
ComputeNoTEosPFFStressTot::getYieldStress(const Real eqpe)
{
  unsigned nsize;
...
Real
ComputeNoTEosPFFStressTot::getdYieldStressdPlasticStrain(const Real eqpe)
{
  unsigned nsize;
  nsize = _yield_stress_vector.size();

#include "ComputeTransportConstants.h"
#include "RankTwoTensor.h"

registerMooseObject("beaverApp", ComputeTransportConstants);

InputParameters
ComputeTransportConstants::validParams()
{
    InputParameters params = DerivativeMaterialInterface<Material>::validParams();
    params.addClassDescription("Compute transport constants Cp and K for HMX"
                                "temperature an pressure dependent terms");
    params.addRequiredCoupledVar("temperature", "temperature variable");
    return params;
}

ComputeTransportConstants::ComputeTransportConstants(const InputParameters & parameters)
...
void
ComputeTransportConstants::computeQpProperties()
{

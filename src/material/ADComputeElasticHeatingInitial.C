#include "ADComputeElasticHeatingInitial.h"

registerMooseObject("mistApp", ADComputeElasticHeatingInitial);

//test: currently changing T to retrieve ADVariableValue

InputParameters
ADComputeElasticHeatingInitial::validParams()
{
...
ADComputeElasticHeatingInitial::ADComputeElasticHeatingInitial(const InputParameters & parameters)
  : Material(parameters),
...
void
ADComputeElasticHeatingInitial::computeQpProperties()
{

...
#include "ComputeIsoPlasticPFFractureStress.h"

registerMooseObject("TensorMechanicsApp", ComputeIsoPlasticPFFractureStress);

InputParameters
ComputeIsoPlasticPFFractureStress::validParams()
{
...
ComputeIsoPlasticPFFractureStress::ComputeIsoPlasticPFFractureStress(const InputParameters & parameters)
...
void
ComputeIsoPlasticPFFractureStress::initQpStatefulProperties()
{
...
void
ComputeIsoPlasticPFFractureStress::computeQpStress()
{
...
// up till this point, we have the updated stress, peos, elastic_strain, plastic strain
  ...
  RankTwoTensor strain0vol, strain0dev;
    ...
    stress0neg =stress - stress0pos; // plastic strain included in stress here
...
Real
ComputeIsoPlasticPFFractureStress::yieldFunction(const RankTwoTensor & stress, const Real yield_stress)
{
  return getSigEqv(stress) - yield_stress;
}

RankTwoTensor
ComputeIsoPlasticPFFractureStress::dyieldFunction_dstress(const RankTwoTensor & sig)
{
...
Real
ComputeIsoPlasticPFFractureStress::dyieldFunction_dinternal(const Real equivalent_plastic_strain)
{
  return -getdYieldStressdPlasticStrain(equivalent_plastic_strain);
}

RankTwoTensor
ComputeIsoPlasticPFFractureStress::flowPotential(const RankTwoTensor & sig)
{
  return dyieldFunction_dstress(sig); // this plasticity model assumes associative flow
}

Real
ComputeIsoPlasticPFFractureStress::internalPotential()
{
  return -1;
}

Real
ComputeIsoPlasticPFFractureStress::getSigEqv(const RankTwoTensor & stress)
{
...
void
ComputeIsoPlasticPFFractureStress::getJac(const RankTwoTensor & sig,
...
Real
ComputeIsoPlasticPFFractureStress::getYieldStress(const Real eqpe)
{
  unsigned nsize;
...
Real
ComputeIsoPlasticPFFractureStress::getdYieldStressdPlasticStrain(const Real eqpe)
{
  unsigned nsize;
  nsize = _yield_stress_vector.size();
